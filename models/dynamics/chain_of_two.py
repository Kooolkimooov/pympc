...
if __name__ == '__main__':
    ...
    print( f"{s=}" )
    print( f"{s[ ch2.position ]=}" )
    print( f"{s[ ch2.orientation ]=}" )
    print( f"{s[ ch2.velocity ]=}" )
    print( f"{s[ ch2.body_rates ]=}" )
    print( f"{s[ ch2.br_0_position ]=}" )
    print( f"{s[ ch2.br_0_orientation ]=}" )
    print( f"{s[ ch2.br_0_velocity ]=}" )
    print( f"{s[ ch2.br_0_body_rates ]=}" )
    print( f"{s[ ch2.br_0_state ]=}" )
    print( f"{s[ ch2.br_1_position ]=}" )
    print( f"{s[ ch2.br_1_orientation ]=}" )
    print( f"{s[ ch2.br_1_velocity ]=}" )
    print( f"{s[ ch2.br_1_body_rates ]=}" )
    print( f"{s[ ch2.br_1_state ]=}" )

    a = random( (ch2.actuation_size,) )
    print( f"{a=}" )
    print( f"{a[ ch2.linear_actuation ]=}" )
    print( f"{a[ ch2.angular_actuation ]=}" )
    print( f"{a[ ch2.br_0_linear_actuation ]=}" )
    print( f"{a[ ch2.br_0_angular_actuation ]=}" )
    print( f"{a[ ch2.br_1_linear_actuation ]=}" )
    print( f"{a[ ch2.br_1_angular_actuation ]=}" )

    p = random( (ch2.state_size // 2,) )
    print( f"{p=}" )
    print( f"{p[ ch2.br_0_perturbation ]=}" )
    print( f"{p[ ch2.br_1_perturbation ]=}" )

    ds = ch2( s, a, p )
    print( f"{ds=}" )
    print( f"{ds[ ch2.position ]=}" )
    print( f"{ds[ ch2.orientation ]=}" )
    print( f"{ds[ ch2.velocity ]=}" )
    print( f"{ds[ ch2.body_rates ]=}" )
    print( f"{ds[ ch2.br_0_position ]=}" )
    print( f"{ds[ ch2.br_0_orientation ]=}" )
    print( f"{ds[ ch2.br_0_velocity ]=}" )
    print( f"{ds[ ch2.br_0_body_rates ]=}" )
    print( f"{ds[ ch2.br_0_state ]=}" )
    print( f"{ds[ ch2.br_1_position ]=}" )
    print( f"{ds[ ch2.br_1_orientation ]=}" )
    print( f"{ds[ ch2.br_1_velocity ]=}" )
    print( f"{ds[ ch2.br_1_body_rates ]=}" )
    print( f"{ds[ ch2.br_1_state ]=}" )
